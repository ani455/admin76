              ...
              <table className="admin-table">
                ...
                <tbody>
                  {users.map((user: any, i: number) => (
                    <motion.tr key={user.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.015 }}>
                      ...
                      <td className="font-mono text-muted-foreground">{String(user.id).slice(0, 8)}</td>
